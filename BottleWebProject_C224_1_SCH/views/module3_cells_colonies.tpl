...
<div class="cells-container">
        ...
        <div class="settings">
            ...
            <p class="leader">
                the field size: 
                <input type="number" class="parameters" name="field_width" id="fieldWidth" value="3" min="1" max="50" style="width: 60px;">
                X
                <input type="number" class="parameters" name="field_height" id="fieldHeight" value="3" min="1" max="50" style="width: 60px;">
            </p>
        <p class="leader">
